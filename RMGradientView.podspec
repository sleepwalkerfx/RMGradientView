#
#  Be sure to run `pod spec lint RMGradientView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Rukshan Marapana"
  # s.authors            = { "Rukshan Marapana" => "rukshan47@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Rukshan Marapana"
